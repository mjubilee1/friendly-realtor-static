...
export default function Image({ id, src, alt, className, onClick, circle, size, ariaLabel, omitMarginAuto, marginBottom }: ImageProps) {
  let defaultStyles = '';
  ...
  return onClick ? (
    ...
    <img src={src} className={`inline-block ${defaultStyles} ${marginBottom} ${className}`} alt={alt} />
  );
}
