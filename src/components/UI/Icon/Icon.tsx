...
import EndeavorsPreAlpha from '../../../icons/endeavors-pre-alpha';
...
import Sleepless from '../../../icons/sleepless';
...
import { IconProp, IconMapProps } from './IconTypes';
...
function getColorClassName(color: string) {
  switch (color) {
    ...
    case 'secondary':
    case 'gray':
      return 'text-endeavors-gray-200';
    case 'dark-gray':
    ...
    case 'green':
      return 'text-endeavors-green-500';
    case 'red':
      return 'text-endeavors-red-400';
    case 'yellow':
      return 'text-yellow-300';
    case 'orange':
      return 'text-orange-500';
    case 'blue':
      return 'text-endeavors-blue-500';
    case 'teal':
...
export default function Icon({ name, color, size, solid, className }: IconProp) {
  if (!name) {
    return null;
  }
  ...
  const iconMap: IconMapProps = {
    'account-check': <AccountCheck formattedClassName={formattedClassName} />,
    ...
    calendar: <Calendar formattedClassName={formattedClassName} />,
    ...
    dot: <Dot formattedClassName={formattedClassName} />,
    ...
    'hamburger-menu': <HamburgerMenu solid={!!solid} formattedClassName={formattedClassName} />,
    ...
    link: <LinkIcon solid={!!solid} formattedClassName={formattedClassName} />,
    linkedin: <LinkedIn formattedClassName={formattedClassName} />,
    'lock-closed': <LockClosed formattedClassName={formattedClassName} />,
    ...
    sleepless: <Sleepless formattedClassName={formattedClassName} />,
    spinner: <Spinner formattedClassName={formattedClassName} />,
    ...
    upload: <Upload formattedClassName={formattedClassName} />,
    user: <User solid={!!solid} formattedClassName={formattedClassName} />,
    'user-add': <UserAdd solid={!!solid} formattedClassName={formattedClassName} />,
