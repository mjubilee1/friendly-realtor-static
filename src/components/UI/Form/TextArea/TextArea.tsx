...
export const FormTextArea = React.forwardRef<HTMLTextAreaElement, TextAreaProps>((props: TextAreaProps, ref) => {
  const { className, helperText, hideLabel, id, label, rows = 4, validationText, ...restProps } = props;
  ...
  return (
    <Group noGutter={hideLabel}>
      ...
      <textarea className={`${className} block w-full`} id={fieldId} ref={ref} rows={rows} {...restProps} />
