...
export const FileInput = React.forwardRef<HTMLInputElement, FileInputProps>((props: FileInputProps, ref) => {
  const { accept, className = '', helperText, hideLabel, id, label = '', name, placeholder, validationText, onChange = () => undefined, text } = props;
  ...
  return (
    <>
      <Group className={`${className} flex flex-wrap items-center rounded-lg gap-2 w-full bg-white`} noGutter={hideLabel}>
        <div>
