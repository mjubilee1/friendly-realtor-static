...
export function FormSelect(props: FormSelectProps) {
  const { className, label, helperText, hideLabel, validationText, width = 'small', ...restProps } = props;
  ...
  return (
    <Group noGutter={hideLabel}>
      ...
      <Select className={`${className || ''}`} id={fieldId} width={width} {...restProps} styles={customStyles} />
