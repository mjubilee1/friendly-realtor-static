...
export const Label = React.forwardRef<HTMLLabelElement | HTMLSpanElement, LabelProps>((props: LabelProps, ref) => {
  ...
  return useSpan ? (
    ...
    <label
      ...
      ref={
        ...
        ref && Object.prototype.hasOwnProperty.call(ref, 'control') && Object.prototype.hasOwnProperty.call(ref, 'form') && Object.prototype.hasOwnProperty.call(ref, 'htmlFor')
